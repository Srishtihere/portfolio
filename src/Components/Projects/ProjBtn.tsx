  ...
  return (
    <div className="flex">
      ...
      <a
        ...
        type="button"
        target="_blank"
        className="flex m-2 justify-center align-middle text-slate-950 bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm p-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
      >
        Website{" "}
        <IoArrowRedoCircleSharp
          size={20}
