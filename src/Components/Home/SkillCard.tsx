...
const SkillCard: React.FC<{ title: string; children: React.ReactNode }> = ({
  ...
  return (
    <div className="relative text-center mt-10 block max-w-sm rounded-lg border border-gray-200 bg-white dark:bg-slate-800  shadow ">
      ...
      <div className="p-3 grid grid-cols-3 gap-1 w-full dark:text-white">
        {children}
      </div>
    </div>
  );
